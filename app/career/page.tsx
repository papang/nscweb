          ...
          {(jobs.length === 0) ? (
            <div className="p-6 md:p-8 border-t border-white/5 bg-black/20 relative z-10">
              <p className="text-center text-[16px] text-gray-400 mt-5 font-medium leading-relaxed">
                Kirimkan Lamaran dan CV Anda (format file: PDF; maks. 50MB) ke <span className="text-orange-500 font-bold">hr@nsc.id</span><br className="hidden sm:block" /> dengan subjek email <span className="text-white font-bold">Lamaran Kerja - [Posisi]</span>.
              </p>
            </div>
          ) : (
            ...
            >
              ...
              <div className="p-6 md:p-8 border-t border-white/5 bg-black/20 relative z-10">
                <p className="text-center text-[14px] text-gray-400 mt-5 font-medium leading-relaxed">
                  Kirimkan Lamaran dan CV Anda (format file: PDF; maks. 50MB) ke <span className="text-orange-500 font-bold">hr@nsc.id</span><br className="hidden sm:block" /> dengan subjek email <span className="text-white font-bold">Lamaran Kerja - {selectedJob.title} - [Nama Anda]</span>.
                </p>
              </div>
            </motion.div>
          </div>
