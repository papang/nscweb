...
// TODO (Backend): Fetch data kategori dari API
        ...
        {isCatModalOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <motion.div initial={{ scale: 0.95, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} exit={{ scale: 0.95, opacity: 0 }} className="relative w-full max-w-sm bg-[#111111] border border-white/10 rounded-3xl p-6">
              ...
              <form onSubmit={(e) => { e.preventDefault(); setIsCatModalOpen(false); }}>
                <label className="block text-xs font-bold uppercase text-gray-400 mb-2">Nama Kategori</label>
                <input type="text" className="w-full bg-black border border-white/10 rounded-xl p-3 text-white focus:outline-none focus:border-orange-500" placeholder="Misal: FTTH" required />
