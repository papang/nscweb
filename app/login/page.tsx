...
import { LogIn, Mail, Lock, ShieldCheck, ChevronLeft, Eye, EyeOff } from "lucide-react";
            ...
            <div className="relative rounded-[24px] border border-white/10 bg-black/60 p-8 backdrop-blur-2xl">
              <form className="space-y-5" onSubmit={handleLogin}>
                ...
                <div className="space-y-2">
                  <div className="flex justify-between items-center px-1">
                    <label className="text-[14px] font-bold text-gray-300">Password</label>
                  </div>
                  <div className="relative">
              ...
              <div className="mt-8 text-center">
                <p className="text-sm text-gray-400">
                  <Link href="/login/reset?step=1" className="text-[14px] font-bold text-orange-500 hover:text-orange-400 transition-colors">Lupa Password?</Link>
                </p>
                <p className="text-sm text-gray-400">
                  Belum punya akun? {" "}
